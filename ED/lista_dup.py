...
class Lista():
    ...
    def adicionar_a_esquerda(self,valor):
        if self.tam==0:
            ...
            noh=self.primeiro
            newnoh=Noh(valor,None,noh)
            noh.esquerdo=newnoh
            self.primeiro=newnoh
        self.tam+=1
    ...
    def remover(self):
        ...
        if self.tam==0:
            ...
            morto=self.primeiro.valor
            self.primeiro=None
            self.ultimo=None
        else:
            morto=self.ultimo.valor
            nohultimo=self.ultimo
            self.ultimo=nohultimo.esquerdo
    ...
    def remover_a_esquerda(self):
        ...
        if self.tam==0:
            ...
            morto=self.primeiro.valor
            nohprimeiro=self.primeiro
            self.primeiro=nohprimeiro.direito
